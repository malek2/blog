<div class="center-block" style="margin-top: 25px;">
    ...
    <fieldset class="">
        ...
        <div class="form-group">
            <label class="control-label"><?php echo __('Rôle'); ?></label>
            <?php echo $this->Form->input('role_id',array('class'=>'form-control','label'=>false)); ?>
        </div>
        <div class="form-group">
            <label class="control-label"><?php echo __('Etat'); ?></label>
            <?php echo $this->Form->input('active',array('class'=>'form-control','label'=>false,'type'=>'checkbox')); ?>
        </div>
